...
/**
 * Cet agent evalue les couples etat-action, et observe l'environnement pour
 * savoir quand une transition est realisee et etre notifie de la recompense
 * recue.
 *
...
public abstract class RLAgent extends ValueAgent implements Observer, IRLAgent {
    ...
    /**
     * Initialise les paramètres, la strategie d'exploration a manuelle, ajoute
     * l'environnement comme observe
     *
     * @param alpha
     * @param gamma
     * @param _env
    ...
    /**
     * initialise les parametres pour un episode d'apprentissage: reset l'etat
    ...
    /**
     * @return liste des actions possibles dans etat _e. Renvoi liste vide si
     * etat absorbant.
     */
    ...
    /**
     * L'environnement notifie l'agent RL lorsque doAction(a) est appele par
     * l'agent. L'agent est notifie avec la recompense recue pour la transition.
     */
    @Override
